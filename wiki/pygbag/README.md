...
### Debugging
If you need to debug your game going forward, you may consider reading the page on [debugging](/pygame-web.github.io/wiki/pygbag-debug/) with Pygbag.

### Publishing 
To let others play your game online, you must publish your game on a publicly accessible website. We provide documentation for publishing [via itch.io](/pygame-web.github.io/wiki/publishing/itch.io/) and [via Github Pages](/pygame-web.github.io/wiki/publishing/github.io/).
