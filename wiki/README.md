...
## Using Pygbag
- Visit [this page](/pygame-web.github.io/wiki/pygbag/) on how to use Pygbag to make web games with Python.
- Visit [this page](/pygame-web.github.io/wiki/pygbag-code/) for useful Pygbag code snippets and a Pygbag FAQ.

## Debugging / Desktop Simulator

- [How to enter debug mode](/pygame-web.github.io/wiki/pygbag-debug/)
...
- [Pygbag-script](/pygame-web.github.io/wiki/pygbag-script/) (WIP)
...
- [Github Pages](/pygame-web.github.io/wiki/publishing/github.io/)
- [Itch.io](/pygame-web.github.io/wiki/publishing/itch.io/)
